# 🛠️ brass-runetime — Mini runtime funcional al estilo ZIO en TypeScript

**brass-runetime** es un runtime funcional, escrito en **TypeScript vanilla** y **sin usar Promises ni async/await** como primitiva principal de modelado.
...
**Nombre del proyecto:** `brass-runetime`  
